...
import de.lalo5.particleeffectlib.util.Disposable;
import de.lalo5.particleeffectlib.util.DynamicLocation;
...
public final class EffectManager implements Disposable {
     ...
     *
     * @param effectClass The name of the Effect class to instantiate. If unqualified, defaults to the de.slikey.particleeffectlib.effect namespace.
    ...
    public Effect start(String effectClass, ConfigurationSection parameters, DynamicLocation origin, DynamicLocation target, Map<String, String> parameterMap) {
        ...
        try {
            ...
            if (!effectClass.contains(".")) {
                effectClass = "de.lalo5.particleeffectlib.effect." + effectClass;
